...
NOTE: The demo/"unsigned" defaults are intentionally removed.
You must configure your own Cloudinary account to use this script.
Unsigned uploads to the demo cloud are publicly accessible.
"""
